...
define('_CRPVIDEO_MOSTVIEWED_VIDEOS','Popular videos');
...
define('_CRPVIDEO_WORDSINTHISTEXT', '%t% total words in this text');
...
define('_CRPVIDEO_EXTERNAL_SOURCE','External url (http://)');
...
define('_CRPVIDEO_SUBMIT', 'Submit video');
define('_CRPVIDEO_TAGS','Tags');
define('_CRPVIDEO_WAITING', 'Waiting to be approved.');
