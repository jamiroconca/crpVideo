 ...
 *
 */
function crpVideo_videosblock_init()
{
	// Security
	pnSecAddSchema('Videosblock::', 'Block title::');
}
 ...
 * 
 */
function crpVideo_videosblock_info()
{
	return array (
		'text_type' => 'crpVideos',
		'module' => 'crpVideo',
		'text_type_long' => 'Latest Videos Titles',
		'allow_multiple' => true,
		'form_content' => false,
		'form_refresh' => false,
		'show_preview' => true
 ...
 */
function crpVideo_videosblock_display($blockinfo)
{
	// security check
	if (!SecurityUtil :: checkPermission('Videosblock::', "$blockinfo[title]::", ACCESS_READ))
		return;
 ...
 */
function crpVideo_videosblock_modify($blockinfo)
{
	// Break out options from our content field
	$vars = pnBlockVarsFromContent($blockinfo['content']);
 ...
 */
function crpVideo_videosblock_update($blockinfo)
{
	// Get current content
	$vars = pnBlockVarsFromContent($blockinfo['content']);
	...
	($vars['carousel'] && !$vars['carousel_direction'])?$vars['carousel_direction']='horizontal':'';
